                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8 offset-lg-2">
                        <h4 style={{ fontFamily: "'IBM Plex Sans', sans-serif", color: "var(--fontColor)" }}>
                            ...
                            I have practical knowledge on Full-stack Development where I am <strong><a href="https://www.google.com" style={{ color: "var(--fontColor)" }}>seeking new opportunities</a></strong> to learn something new.
                            I have done <strong><a href="https://github.com/Somanyu" style={{ color: "var(--fontColor)" }}>200+ commits</a></strong> to total <strong><a href="https://github.com/Somanyu?tab=repositories" style={{ color: "var(--fontColor)" }}>20+ repos</a></strong> in my GitHub. Did 2 internships on web development.
                            I am <strong><a href="mailto:somanyu.03samal@gmail.com" style={{ color: "var(--fontColor)" }}>open to collaborate</a></strong> on projects. <br /><br /> My passion lies in solving business problems with tailored data and algorithms and communicating complex ideas to non-technical stakeholders. I am able to jump across verticals to deliver high-performing solutions.
                        </h4>
                    </div>
                </div>
